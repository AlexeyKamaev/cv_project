...
st.page_link("pages/autoenc.py", label=":red[***ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК***]", icon='📝')
with st.echo():
    st_lottie("https://lottie.host/d50d44da-8c5f-48da-af8b-57ad93b6e14c/h139wgXhFw.json")
    
st.subheader('Yolo_v8', divider='rainbow')
st.page_link("pages/myapp.py", label=":green[***ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК-ТЫК***]", icon='⚡')
with st.echo():
